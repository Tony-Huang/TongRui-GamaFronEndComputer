...
( NAME = N'ShangWeiJi', FILENAME = N'c:\Program Files\Microsoft SQL Server\MSSQL.1\MSSQL\DATA\ShangWeiJi.mdf' , SIZE = 3072KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'ShangWeiJi_log', FILENAME = N'c:\Program Files\Microsoft SQL Server\MSSQL.1\MSSQL\DATA\ShangWeiJi_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
END
...
GO
/*GRANT CONNECT TO [ShangWeiJiUser1] by wys*/
...
CREATE LOGIN [ShangWeiJiUser1] WITH PASSWORD=N'ShangWeiJiUser1', DEFAULT_DATABASE=[ShangWeiJi], DEFAULT_LANGUAGE=[简体中文], CHECK_EXPIRATION=OFF, CHECK_POLICY=OFF
GO
